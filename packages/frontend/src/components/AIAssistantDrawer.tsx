...
export function AIAssistantDrawer({ isOpen, onClose, selectedCollegeId }: AIAssistantDrawerProps) {
  ...
  return (
    <div
      className="fixed inset-0 z-[9999] overflow-hidden bg-slate-950/70 backdrop-blur-md flex justify-end transition-opacity"
      onClick={onClose}
    >
      <div
        className="relative w-full max-w-2xl bg-slate-900 text-slate-100 h-full shadow-2xl flex flex-col border-l border-slate-800 animate-in slide-in-from-right duration-300 z-[10000]"
      ...
      >
        ...
        {/* Query Input Section */}
        <div className="p-4 bg-slate-900/90 border-b border-slate-800/80 space-y-3 shrink-0">
